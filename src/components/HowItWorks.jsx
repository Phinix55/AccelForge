...
const HowItWorks = () => {
    return (
        <section className="bg-accent-primary py-16 px-8 relative overflow-hidden bg-[linear-gradient(rgba(255,255,255,0.08)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.08)_1px,transparent_1px)] bg-size-[60px_60px] text-white text-center max-[768px]:py-10 max-[768px]:px-4">
            <div className="max-w-[1000px] mx-auto mb-16 max-[768px]:mb-8">
                <ScrollReveal>
                    <h2 className="text-[3rem] font-medium mb-6 tracking-[-0.02em] leading-[1.2] max-[1024px]:text-[2.5rem] max-[1024px]:mb-1 max-[768px]:text-[2.2rem] max-[768px]:mb-3 max-[768px]:leading-[1.2]">Why Choose Us?</h2>
                </ScrollReveal>
                <ScrollReveal delay={0.1}>
                    <p className="text-[1.8rem] leading-[1.6] opacity-90 font-light max-w-[800px] mx-auto max-[768px]:text-[1rem] max-[768px]:mb-8 max-[768px]:px-2">
                       Sales is not an art. It is science.
                    </p>
                </ScrollReveal>
            </div>

            <div className="grid grid-cols-3 gap-6 max-w-[1200px] mx-auto mb-4 max-[1024px]:grid-cols-1 max-[1024px]:max-w-[600px] max-[768px]:gap-4 max-[768px]:mb-8">
                <ScrollReveal delay={0.2}>
                    <div className="bg-white text-text-primary rounded-3xl p-10 pb-8 text-left min-h-[280px] flex flex-col transition-all duration-300 ease-out cursor-default hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(0,0,0,0.2)] max-[768px]:p-6 max-[768px]:min-h-0 max-[768px]:rounded-[20px]">
                        <div className="text-[3.5rem] font-normal mb-2 text-text-primary opacity-100 max-[768px]:text-[3rem] max-[768px]:mb-1">1</div>
                ...
                <ScrollReveal delay={0.3}>
                    <div className="bg-white text-text-primary rounded-3xl p-10 text-left min-h-[280px] flex flex-col transition-all duration-300 ease-out cursor-default hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(0,0,0,0.2)] max-[768px]:p-6 max-[768px]:min-h-0 max-[768px]:rounded-[20px]">
                        <div className="text-[3.5rem] font-normal mb-2 text-text-primary opacity-100 max-[768px]:text-[3rem] max-[768px]:mb-1">2</div>
                ...
                <ScrollReveal delay={0.4}>
                    <div className="bg-white text-text-primary rounded-3xl p-10 text-left min-h-[280px] flex flex-col transition-all duration-300 ease-out cursor-default hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(0,0,0,0.2)] max-[768px]:p-6 max-[768px]:min-h-0 max-[768px]:rounded-[20px]">
                        <div className="text-[3.5rem] font-normal mb-2 text-text-primary opacity-100 max-[768px]:text-[3rem] max-[768px]:mb-1">3</div>
