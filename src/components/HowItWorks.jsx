...
const HowItWorks = () => {
    return (
        <section className="bg-accent-primary rounded-3xl py-16 px-8 mx-4 mb-8 relative overflow-hidden bg-[linear-gradient(rgba(255,255,255,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.05)_1px,transparent_1px)] bg-[size:60px_60px] text-white text-center max-[768px]:py-10 max-[768px]:px-4">
            ...
            <div className="grid grid-cols-3 gap-6 max-w-[1200px] mx-auto mb-12 max-[1024px]:grid-cols-1 max-[1024px]:max-w-[600px] max-[768px]:gap-4 max-[768px]:mb-8">
                <ScrollReveal delay={0.2}>
                    <div className="bg-white text-text-primary rounded-3xl p-10 text-left min-h-[280px] flex flex-col transition-all duration-300 ease-out cursor-default hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(0,0,0,0.2)] max-[768px]:p-6 max-[768px]:min-h-0 max-[768px]:rounded-[20px]">
                        ...
                        <p className="text-[1rem] text-gray-500 leading-[1.6] max-[1024px]:text-[0.9rem] max-[1024px]:leading-[1.5] max-[768px]:text-[0.95rem]">
